...
class OwnerController {
    ...
    @Autowired
    public OwnerController(OwnerRepository clinicService, OrderRepository orderRepository) {
...
//		 logger.info("Orden creada: " + newOrder);
		 return null;//ResponseEntity.ok(newOrder);
    }
